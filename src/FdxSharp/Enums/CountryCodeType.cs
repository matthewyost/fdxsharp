...
{
	/// <summary>
	/// Represents the country code type for specifying countries as per the FDX standard.
	/// </summary>
	/// <summary>
	...
	public enum CountryCodeType
	{
		...
		PR,
		/// <summary>Palestinian Territory</summary>
		PS,
